...
print(xml)`,
  },
  {
    ...
    label: 'TypeScript',
    lang: 'typescript',
    code: `import { client, zDebitNote } from "@openubl/sdk";\n\nconst debitNote = zDebitNote.parse({\n  serie: \"FC01\",\n  numero: 1,\n  comprobanteAfectadoSerieNumero: \"F001-45\",\n  sustentoDescripcion: \"Intereses moratorios\",\n  proveedor: {\n    ruc: \"20100100100\",\n    razonSocial: \"Mi Empresa S.A.C.\",\n  },\n  cliente: {\n    nombre: \"Juan Pérez\",\n    numeroDocumentoIdentidad: \"46779327\",\n    tipoDocumentoIdentidad: \"1\",\n  },\n  detalles: [\n    {\n      descripcion: \"Intereses moratorios - Laptop Dell XPS 13\",\n      cantidad: \"1\",\n      precio: \"150.00\",\n    },\n  ],\n});\n\nconst { data, error } = await client.post(\"/api/v1/debit-note/create?validate=true\", {\n  body: debitNote,\n});\n\nif (error) {\n  throw new Error(JSON.stringify(error));\n}\n\nconsole.log(data.xml);`,
  },
  {
    id: 'curl',
    label: 'cURL',
