...
:::caution[Requisito para clientes HTTP]
Si usas Python nativo, este tutorial funciona directamente. Si usas cURL, el SDK TypeScript o Python vía HTTP, asegúrate de tener el servidor corriendo en `http://localhost:8000` (ver [Levantar el servidor](/openUBL/getting-started/levantar-servidor/)).
:::
