...
El XML se firma digitalmente con un certificado en formato PEM/PFX. openUBL usa el algoritmo **RSA-SHA-256**, digestión **SHA-256** y canonicalización **C14N**, ubicando la firma XMLDSig en `UBLExtension/ExtensionContent`. Esta configuración cumple con la estructura exigida por SUNAT y con los requisitos SHA-2 de INDECOPI/IOFE y la Directiva PCM 002-2024.
