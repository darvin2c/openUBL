...
|--------|------|--------|-----------|
| POST | `/api/v1/credit-note/create` | [`CreditNoteCreateRequest`](#creditnotecreaterequest) | [`CreateResponse`](#createresponse) |
| POST | `/api/v1/debit-note/create` | [`DebitNoteCreateRequest`](#debitnotecreaterequest) | [`CreateResponse`](#createresponse) |
| POST | `/api/v1/invoice/create` | [`InvoiceCreateRequest`](#invoicecreaterequest) | [`CreateResponse`](#createresponse) |
| POST | `/api/v1/perception/create` | [`PerceptionCreateRequest`](#perceptioncreaterequest) | [`CreateResponse`](#createresponse) |
| POST | `/api/v1/retention/create` | [`RetentionCreateRequest`](#retentioncreaterequest) | [`CreateResponse`](#createresponse) |
| POST | `/api/v1/sign` | — | [`SignedXmlResponse`](#signedxmlresponse) |
| POST | `/api/v1/summary-documents/create` | [`SummaryDocumentsCreateRequest`](#summarydocumentscreaterequest) | [`CreateResponse`](#createresponse) |
| GET | `/api/v1/version` | — | — |
| POST | `/api/v1/voided-documents/create` | [`VoidedDocumentsCreateRequest`](#voideddocumentscreaterequest) | [`CreateResponse`](#createresponse) |
...
| `documento` | [`CreditNote`](#creditnote) | Sí | — |
...
|-----------|------|-----------|-------------|
| `credenciales` | union | No | — |
| `documento` | [`DebitNote`](#debitnote) | Sí | — |
| `firmar` | boolean | No | default: `False` |
| `signature_id` | string | No | default: `SignSUNAT` |
| `validar_sunat` | boolean | No | default: `True` |
...
|-----------|------|-----------|-------------|
| `credenciales` | union | No | — |
| `documento` | [`Perception`](#perception) | Sí | — |
| `firmar` | boolean | No | default: `False` |
| `signature_id` | string | No | default: `SignSUNAT` |
| `validar_sunat` | boolean | No | default: `True` |
...
|-----------|------|-----------|-------------|
| `credenciales` | union | No | — |
| `documento` | [`Retention`](#retention) | Sí | — |
| `firmar` | boolean | No | default: `False` |
| `signature_id` | string | No | default: `SignSUNAT` |
| `validar_sunat` | boolean | No | default: `True` |
...
|-----------|------|-----------|-------------|
| `credenciales` | union | No | — |
| `documento` | [`SummaryDocuments`](#summarydocuments) | Sí | — |
| `firmar` | boolean | No | default: `False` |
| `signature_id` | string | No | default: `SignSUNAT` |
| `validar_sunat` | boolean | No | default: `True` |
...
|-----------|------|-----------|-------------|
| `credenciales` | union | No | — |
| `documento` | [`VoidedDocuments`](#voideddocuments) | Sí | — |
| `firmar` | boolean | No | default: `False` |
| `signature_id` | string | No | default: `SignSUNAT` |
| `validar_sunat` | boolean | No | default: `True` |
